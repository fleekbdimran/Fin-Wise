    ...
    return (
        <>
            ...
            <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-[40px] sm:text-[36px] font-extrabold text-[#006B7F] leading-[60px] tracking-[0.5px] text-center">
                        Our Services
                    </h2>

                    <p className="mt-4 text-lg sm:text-base font-poppins font-medium leading-[27px] tracking-[0.5px] text-center">
                        Explore the range of loan options and financial solutions we <br /> offer to meet your needs.
                    </p>
                </div>
