    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center text-white z-10 px-4 md:px-8 ">
          <div className="max-w-3xl mx-auto flex flex-col items-center justify-center text-center">
            <h1 className="font-poppins font-bold text-[32px] sm:text-[40px] lg:text-[48px] text-[#000] leading-[60px] mb-6 md:mt[70px]">
      ...
      <div className="lg:hidden  py-32">
        <div className="max-w-xl mx-auto text-center">
          ...
          <button className="w-[134px] h-[48px] bg-transparent border-2 border-[#E4AE4C] text-[#E4AE4C] hover:bg-[#E4AE4C] hover:text-white transition duration-300 rounded-full px-5 py-3 flex items-center justify-center text-center mx-auto gap-2">
            Learn More
          </button>
        </div>
      </div>
      ...
      {/* Cards Section */}
      <div className="flex flex-col items-center justify-center text-center md:mt-[-150px] px-4 md:px-8">
