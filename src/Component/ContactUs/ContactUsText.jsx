...
const ContactUsText = () => {
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center mt-20 relative z-10 px-4 sm:px-6 md:px-8 lg:px-12">
                <h2
                    className="w-96 h-auto text-3xl sm:text-4xl lg:text-4xl font-bold text-gray-800 leading-15 text-center mb-8 mt-10"
                    style={{ fontFamily: 'Poppins', fontWeight: 700 }}
                >
                    Get in Touch with Us
                </h2>
                <p
                    className="w-full sm:w-[696px] h-auto text-gray-600 text-base sm:text-lg text-center mb-8"
                    style={{ fontFamily: 'Poppins', fontWeight: 400 }}
                >
                    We’re here to assist you with any questions or concerns. Whether you need
                    support with your loan application or have inquiries about our company,
