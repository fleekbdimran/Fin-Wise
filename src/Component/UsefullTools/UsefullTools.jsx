...
const UsefullTools = () => {
    ...
    console.log("PieChart component is rendering...");
    ...
    const data = {
        ...
        datasets: [
            {
                data: [6, 4, 6],
                backgroundColor: ["#f36c6c", "#77c9e1", "#ffcc96"],
                borderWidth: 0,
            },
        ],
    };
                                        ...
                                        <div className="w-full text-center mb-6">
                                            ...
                                            <div className="flex justify-center items-center mt-4 space-x-14">
                                                ...
                                                <div className="relative w-[110px] h-[110px] rounded-full flex items-center justify-center">
                                                    ...
                                                    {/* Numbers on Color Segments */}
                                                    <div className="absolute top-[40%] right-[75%] transform -translate-x-1/2 -translate-y-1/2 ">
                                                        <span className="text-xs font-semibold text-black">6</span>
                                                    </div>
                                                    <div className="absolute bottom-[20%] left-[50%] transform -translate-x-1/2 translate-y-1/2">
                                                        <span className="text-xs font-semibold text-black">4</span>
                                                    </div>
                                                    <div className="absolute top-[40%] right-[15%] transform translate-x-1/2 -translate-y-1/2">
                                                        <span className="text-xs font-semibold text-black">6</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="w-full text-center mb-6">
                                            ...
                                            <div className="flex justify-center items-center mt-4 space-x-14">
                                                ...
                                                {/* <div className="w-[110px] h-[110px] rounded-full flex items-center justify-center relative">
