  ...
  return (
    <footer className="bg-gradient-to-b from-white to-[#03658C] text-white pt-12 mt-20">
      ...
      <div className="flex items-center justify-center">
        <div className="bg-[#3b3b50] text-white rounded-[40px] p-[45.39px] mb-8 w-full max-w-[1068.68px] h-auto gap-[9.08px]">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            {/* Logo and Mission */}
            <div className="mb-4 lg:mb-2 text-center lg:text-left">
              <h2 className="text-2xl font-bold mb-2 flex items-center justify-center lg:justify-start">
                <span className="mr-2">
                  <img
                    src={Finwiselogo}
                    alt="Finwiselogo"
              ...
              <p className="max-w-[543px] mx-auto lg:mx-0 text-gray-300 font-roboto font-normal text-base leading-6 tracking-[0.01em]">
      ...
      {/* Links Section */}
      <div className="flex flex-wrap justify-center items-start md:gap-[80px]">
        {/* Social Links */}
        <div className="w-full sm:w-[193px] h-[174.39px] text-center sm:text-left mb-4">
        ...
        {/* Company Links */}
        <div className="w-full sm:w-[193px] h-[185px] text-center sm:text-left mb-4">
        ...
        {/* Useful Links */}
        <div className="w-full sm:w-[193px] h-[147px] text-center sm:text-left mb-4">
        ...
        {/* Address */}
        <div className="w-full sm:w-[193px] h-[119px] text-center sm:text-left mb-4">
      ...
      {/* Footer Bottom */}
      <div className="md:pl-[800px] text-center text-sm py-4">
